  ...
  function CarouselPage() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = CarouselPage.__proto__ || Object.getPrototypeOf(CarouselPage)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "render", {
      ...
      value: function value() {
        ...
        }, __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Fragment, {
          __source: {
            fileName: _jsxFileName,
            lineNumber: 14
          }
...
Object(__WEBPACK_IMPORTED_MODULE_0_react_emotion__["a" /* default */])('main', {
  target: "esw7gm00"
})("display:block;left:0;margin:auto;overflow:hidden;padding-bottom:15rem;position:absolute;right:0;top:0;transition:background .66s ease-in-out;");
    (function (Component, route) {
      if(!Component) return
      if (false) return
      module.hot.accept()
...
//# sourceMappingURL=5.a5dab40b5e1c2348feb9.hot-update.js.map