...
Object(__WEBPACK_IMPORTED_MODULE_0_react_emotion__["a" /* default */])('main', {
  ...
  return theme.teal;
}, ";display:block;left:0;margin:auto;min-height:100vw;overflow:hidden;padding-bottom:15rem;position:absolute;right:0;top:0;transition:background .66s ease-in-out;&.center{background-color:", function (_ref2) {
  var theme = _ref2.theme;
  return theme.white;
}, ";max-width:70vw;position:static;}&.previous{transform:translateX(calc( -1 * 100vw + ( ( 100vw - 70vw ) / 2 ) + 8rem ));}&.next{transform:translateX(calc( 100vw - ( ( 100vw - 70vw ) / 2 ) - 8rem ));}");
...
//# sourceMappingURL=5.b0cb558f0ecc84378775.hot-update.js.map